...
service UserAPI{
	 ...
	 * @return UserInfo.User = return an User Information
	 */
	UserInfo.User signupWithFacebook(1: string fb_id, 2: string email, 3: string pic_url) throws (1: UserInfo.UserException uex);
	 ...
	 * @return UserInfo.User = return an User Information
	 */
	UserInfo.User signupWithKakao(1: string ko_id, 2: string email, 3: string pic_url) throws (1: UserInfo.UserException uex);

	/** sign in
	 * @param string token -
	 * @return UserInfo.User - return an User Information
	 */
	 UserInfo.User signin(1: string token) throws (1: UserInfo.UserException uex);
