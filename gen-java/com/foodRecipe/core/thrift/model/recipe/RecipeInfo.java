...
public class RecipeInfo implements org.apache.thrift.TBase<RecipeInfo, RecipeInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CALORIES,_Fields.LEVEL,_Fields.COOK_TIME,_Fields.INGREDIENT};
  ...
  public RecipeInfo(RecipeInfo other) {
    ...
    if (other.isSetIngredient()) {
      List<IngredientInfo> __this__ingredient = new ArrayList<IngredientInfo>();
  ...
  public int compareTo(RecipeInfo other) {
    ...
    RecipeInfo typedOther = (RecipeInfo)other;

    lastComparison = Boolean.valueOf(isSetCalories()).compareTo(typedOther.isSetCalories());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCalories()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.calories, typedOther.calories);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetCookTime()).compareTo(typedOther.isSetCookTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCookTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cookTime, typedOther.cookTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIngredient()).compareTo(typedOther.isSetIngredient());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIngredient()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ingredient, typedOther.ingredient);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  IngredientInfo _elem2; // required
                  _elem2 = new IngredientInfo();
                  _elem2.read(iprot);
                  struct.ingredient.add(_elem2);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          {
            IngredientInfo _elem7; // required
            _elem7 = new IngredientInfo();
            _elem7.read(iprot);
            struct.ingredient.add(_elem7);
          }
        }
        struct.setIngredientIsSet(true);
      }
