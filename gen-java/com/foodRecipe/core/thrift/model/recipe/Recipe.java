...
public class Recipe implements org.apache.thrift.TBase<Recipe, Recipe._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.RECIPE_ID,_Fields.WRITER_ID,_Fields.WRITER_PIC,_Fields.WRITER_NAME,_Fields.RECIPE_NAME,_Fields.RECIPE_PIC,_Fields.RECIPE_COMMENT,_Fields.RECIPE_INFO,_Fields.RECIPE_LIKED,_Fields.RECIPE_TYPE};
  ...
  public int compareTo(Recipe other) {
    ...
    Recipe typedOther = (Recipe)other;

    lastComparison = Boolean.valueOf(isSetRecipeId()).compareTo(typedOther.isSetRecipeId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeId, typedOther.recipeId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetWriterPic()).compareTo(typedOther.isSetWriterPic());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWriterPic()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.writerPic, typedOther.writerPic);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetRecipeName()).compareTo(typedOther.isSetRecipeName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeName, typedOther.recipeName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRecipePic()).compareTo(typedOther.isSetRecipePic());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipePic()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipePic, typedOther.recipePic);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRecipeComment()).compareTo(typedOther.isSetRecipeComment());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeComment()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeComment, typedOther.recipeComment);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRecipeInfo()).compareTo(typedOther.isSetRecipeInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeInfo, typedOther.recipeInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRecipeLiked()).compareTo(typedOther.isSetRecipeLiked());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeLiked()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeLiked, typedOther.recipeLiked);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRecipeType()).compareTo(typedOther.isSetRecipeType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecipeType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recipeType, typedOther.recipeType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Recipe struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // RECIPE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.recipeType = RECIPETYPE.findByValue(iprot.readI32());
